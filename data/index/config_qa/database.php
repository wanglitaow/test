...
for($i = 0; $i < 10; ++$i){
	...
	$G_CONFIG['database']['queue_master_' . $i]['sDSN'] = $G_CONFIG['database']['queue_slave_' . $i]['sDSN'] = 'mysql:host=10.59.72.32;port=3306;dbname=queue_db_' . $i;
} // 线上配置
$G_CONFIG['database']['log_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=log_db;port=3306;',
		'sUsername' => 'log',
		'sUserpwd' => 'log',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['service_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=service_db;port=3306;',
		'sUsername' => 'service',
		'sUserpwd' => 'service',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['dfs_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=dfs_db;port=3306;',
		'sUsername' => 'dfs',
		'sUserpwd' => 'dfs',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['loupan_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=loupan_db;port=3306;',
		'sUsername' => 'loupan',
		'sUserpwd' => 'loupan',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['user_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=user_db;port=3306;',
		'sUsername' => 'user',
		'sUserpwd' => 'user',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['common_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=common_db;port=3306;',
		'sUsername' => 'common',
		'sUserpwd' => 'common',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['housing_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=housing_db;port=3306;',
		'sUsername' => 'housing',
		'sUserpwd' => 'housing',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['haoguanjia_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=haoguanjia_db;port=3306;',
...
$G_CONFIG['database']['hfb_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=hfb_db;port=3306;',
		'sUsername' => 'hfb',
		'sUserpwd' => 'hfb',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['payment_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=payment_db;port=3306;',
		'sUsername' => 'payment',
		'sUserpwd' => 'payment',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['paycenter_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=paycenter_db;port=3306;',
		'sUsername' => 'paycenter',
		'sUserpwd' => 'paycenter',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['event_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=event_db;port=3306;',
		'sUsername' => 'event',
		'sUserpwd' => 'event',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['api_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=api_db;port=3306;',
		'sUsername' => 'api',
		'sUserpwd' => 'api',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['misc_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=databuilding_db;port=3306;',
		'sUsername' => 'misc',
		'sUserpwd' => 'misc',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['permission_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=permission_db;port=3306;',
...
$G_CONFIG['database']['survey_master'] = array( 
		'sDSN' => 'mysql:host=10.59.72.32;dbname=survey_db;port=3306;',
		'sUsername' => 'survey',
		'sUserpwd' => 'survey',
		'aInitsql' => array( 
				'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['oversea_master'] = array( 
    'sDSN' => 'mysql:host=10.59.72.32;dbname=hw_db;port=3306;', 
    'sUsername' => 'hw', 
    'sUserpwd' => 'hw', 
    'aInitsql' => array( 
        'SET CHARACTER SET utf8', 
...
$G_CONFIG['database']['ask_master'] = array(
    'sDSN' => 'mysql:host=10.59.72.32;dbname=ask_db;port=3306',
    'sUsername' => 'ask',
    'sUserpwd' => 'ask',
    'aInitsql' => array(
        'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['zt_slave'] = array( 
    'sDSN' => 'mysql:host=10.59.72.32;dbname=zt_db;port=3306',
    'sUsername' => 'zt',
    'sUserpwd' => 'zt',
    'aInitsql' => array(
        'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['crm_slave'] = array( 
    'sDSN' => 'mysql:host=10.59.72.32;dbname=crm_db;port=3306',
    'sUsername' => 'crm',
    'sUserpwd' => 'crm',
    'aInitsql' => array(
        'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['crowd_slave'] = array( 
    'sDSN' => 'mysql:host=10.59.72.32;dbname=crowd_db;port=3306',
    'sUsername' => 'crowd',
    'sUserpwd' => 'crowd',
    'aInitsql' => array(
        'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['oa_master'] = array(
    'sDSN' => 'mysql:host=10.59.72.32;dbname=oa_db;port=3306',
    'sUsername' => 'oa',
    'sUserpwd' => 'oa',
    'aInitsql' => array(
        'SET CHARACTER SET utf8',
...
$G_CONFIG['database']['finance_master'] = array(
    'sDSN' => 'mysql:host=10.59.72.32;dbname=finance_db;port=3306',
    'sUsername' => 'finance',
    'sUserpwd' => 'finance',
    'aInitsql' => array(
        'SET CHARACTER SET utf8',
