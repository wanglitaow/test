...
$G_CONFIG['common']['sCookieBaseDomain'] = '.dev.anhouse.com.cn'; //线上配置,各业务可以独立配置
$G_CONFIG['common']['sBaseDomain'] = '.dev.anhouse.com.cn'; //线上配置 
...
$G_CONFIG['common']['sDownloadDomain'] = 'd.dev.anhouse.com.cn';
