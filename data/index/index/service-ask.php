...
define('APP_NAME', 'app-service-ask');
define('APP_PATH', ROOT . '/app-service-ask');
define('APP_CFG_PATH', ROOT . '/app-service-ask/config');
define('CST_CFG_PATH', CFG_PATH . '/hf/service-ask');
