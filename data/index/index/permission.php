...
define('APP_NAME', 'app-hf-permission');
define('APP_PATH', ROOT . '/app-hf-permission');
define('APP_CFG_PATH', ROOT . '/app-hf-permission/config');
define('CST_CFG_PATH', CFG_PATH . '/hf/permission');
