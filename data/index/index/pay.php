...
define('APP_NAME', 'app-hf-paycenter');
define('APP_PATH', ROOT . '/app-hf-paycenter');
define('APP_CFG_PATH', ROOT . '/app-hf-paycenter/config');
define('CST_CFG_PATH', CFG_PATH . '/hf/paycenter');
...
define('APP_MEMBER_PATH', ROOT . '/app-hf-member');
define('APP_MEMBER_CFG_PATH', ROOT . '/app-hf-member/config');
