...
define('APP_NAME', 'app-hf-steward');
define('APP_PATH', ROOT . '/app-hf-steward');
define('APP_CFG_PATH', ROOT . '/app-hf-steward/config');
define('CST_CFG_PATH', CFG_PATH . '/hf/steward');
