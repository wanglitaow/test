...
define('APP_NAME', 'app-hf-hkagent');
define('APP_PATH', ROOT . '/app-hf-hkagent');
define('APP_CFG_PATH', ROOT . '/app-hf-hkagent/config');
define('CST_CFG_PATH', CFG_PATH . '/hf/hkagent');
