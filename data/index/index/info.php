...
define('APP_NAME', 'app-hf-resource');
define('APP_PATH', ROOT . '/app-hf-resource');
define('APP_CFG_PATH', ROOT . '/app-hf-resource/config');
define('CST_CFG_PATH', CFG_PATH . '/hf/info');
