...
define('APP_NAME', 'app-hf-manage');
define('APP_PATH', ROOT . '/app-hf-manage');
define('APP_CFG_PATH', ROOT . '/app-hf-manage/config');
define('CST_CFG_PATH', CFG_PATH . '/hf/manage');
...
define('APP_PAY_PATH', ROOT . '/app-hf-paycenter');
define('APP_PAY_CFG_PATH', ROOT . '/app-hf-paycenter/config');
