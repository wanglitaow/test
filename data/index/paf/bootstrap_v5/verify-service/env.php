...
require_once getenv('PATH_VENDOR') . DIRECTORY_SEPARATOR . 'autoload.php';

$sAppName     = 'verify-service';
$sFile        = env('PATH_VERSION') . DIRECTORY_SEPARATOR . "{$sAppName}.json";
$oVersion     = json_decode(file_get_contents($sFile, true));

EnvLoader::setEnvironmentVariable('CURRENT_VERSION', $oVersion->ga);

return env('PATH_APP') . DIRECTORY_SEPARATOR . $sAppName . DIRECTORY_SEPARATOR . env('CURRENT_VERSION');
