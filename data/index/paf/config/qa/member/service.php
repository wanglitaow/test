...
return array(
    "member" => array(
        ...
        "host" => "member.".PAF_CLOUD.".qa.anhouse.com.cn",
        "uri" => array(
    ...
    "hfb" => array(
        ...
        "host" => "hfb.".PAF_CLOUD.".qa.anhouse.com.cn",
        "uri" => array(
        ),
    ),
    "steward" => array(
        ...
        "host" => "steward.hekai.qa.anhouse.com.cn",
        "uri" => array(
        ),
    ),
    "hfb_sign" => array(
    ...
    "zc_sign" => array(
        ...
        "sign" => true,
        "signSalt" => 'HAOFANGBAO###$!#@%&$#@$!@2@$!3!$13^&254#',
        "host" => "zc.".PAF_CLOUD.".qa.anhouse.com.cn",
        "uri" => array(
        ),
    ),
    "zjd" => array(
    ...
    "gold" => array(
        "strategy" => "http",
        "protocol" => "Util\\Service\\Protocol\\JsonCodeProtocol",
        "host" => "gold.".PAF_CLOUD.".qa.anhouse.com.cn",
        "uri" => array(
        ),
    ),
    "fsjl" => array(
        ...
        "host" => "hft.".PAF_CLOUD.".qa.anhouse.com.cn",
        "uri" => array(
        ),
    ),
    "esf" => array(
        ...
        "host" => "esf.".PAF_CLOUD.".qa.anhouse.com.cn",
        "uri" => array(
        ),
    ),
