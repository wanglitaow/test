...
define('APP_NAME', 'app-service-sms');
define('APP_PATH', ROOT . '/app-service-sms');
define('APP_CFG_PATH', ROOT . '/app-service-sms/config');
define('CST_CFG_PATH', CFG_PATH . '/hf/service-sms');
